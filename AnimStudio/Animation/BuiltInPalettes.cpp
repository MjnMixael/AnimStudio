...
static const QVector<BuiltInPalette> builtInPalettes = {
    ...
    { "FS1 Ship",   QVector<QRgb>(std::begin(Fs1SelectShipPalette), std::end(Fs1SelectShipPalette)) },
    { "FS1 Weapon", QVector<QRgb>(std::begin(Fs1SelectWepPalette), std::end(Fs1SelectWepPalette)) },
    { "FS2 Ship",   QVector<QRgb>(std::begin(Fs2SelectShipPalette), std::end(Fs2SelectShipPalette)) },
    { "FS2 Weapon", QVector<QRgb>(std::begin(Fs2SelectWepPalette), std::end(Fs2SelectWepPalette)) },
};
