 ...
 */
 ...
 // This version has been modified for use in AnimStudio in order to load APNGs only into our custom AnimationData structure.
...
int load_apng(wchar_t * szIn, std::vector<Image>& img)
{
  FILE * f;
