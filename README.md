...
1. Load Animation
Open a .ani, .eff, .apng/.png, or folder of images to begin. Supported image formats include PNG, BMP, JPG, PCX, TGA, DDS. More types may be supported in the future.
...
| `-e`  | `--ext`           | For `raw` export: Image extension (e.g., `png`, `jpg`, `bmp`, `pcx`, `tga`, `dds`) |
...
- EFF: Image sequence export with .eff metadata file. Supports PNG, JPG, BMP, PCX, TGA, DDS.
